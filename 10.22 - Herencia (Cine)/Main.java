	...
	public static void main(String[] args) {
		...
		if (opcion.equals("s")) {
			...
			do {
				...
				modo = sc5.nextLine();
				if(modo.equals("n")) {
					Historial[] comprasCliente = new Historial[5];
					comprasCliente[0] = new Historial(3349);
					comprasCliente[1] = new Historial(40239);
					comprasCliente[2] = new Historial(240);
					comprasCliente[3] = new Historial(30.4);
					comprasCliente[4] = new Historial(15500.99);
					FechaPrimeraCompra fechaPrimeraCompraPrueba = new FechaPrimeraCompra("30", "06", "2018");
					Nombre nombrePrueba = new Nombre("Ramiro", "Castellanos", "Barron");
					imprimirFechaNacimiento();
					FechaNacimiento fechaNacimientoPrueba = new FechaNacimiento("02", "05", "2000");
					imprimirTituloDatosDireccion();
					Direccion direccionPrueba = new Direccion("La Gloria", 220, 66247, "Hacienda del Rosario", "San Pedro", "Nuevo Leon");
					FechaUltimaCompra fechaUltimaCompraPrueba = new FechaUltimaCompra("18", "10", "2021");
					imprimirDatosFactura();
					Cliente cliente = new Cliente(nombrePrueba, direccionPrueba, fechaNacimientoPrueba, "+52(1)812-080-0336", fechaPrimeraCompraPrueba, fechaUltimaCompraPrueba, comprasCliente);
