...
public class Compra {
	...
	public Compra (Detalle[] detalle, FechaActual fechaActual, double subtotal, double descuento, double impuesto, double total, Cliente cliente) {
		setDetalle(detalle);
	...
	public void setFechaActual(FechaActual fechaActual) {
		this.fechaActual = fechaActual;
	}
	public FechaActual getFechaActual() {
		return fechaActual;
	}
	...
	public void mostrarDetallesCompra(int contadorDetalles, double cant, int id, String unidad, String descripcion, double precio, double imp) {
